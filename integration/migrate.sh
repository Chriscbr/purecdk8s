...
find "$project" -type f -name '*.go' -exec sed -i \
  ...
  -e 's|github.com/cdk8s-team/cdk8s-plus-go/cdk8splus34/v2|github.com/purecdk8s/purecdk8s/cdk8splus34/v2|g' \
  -e 's|github.com/cdk8s-team/cdk8s-plus-go/cdk8splus35/v2|github.com/purecdk8s/purecdk8s/cdk8splus35/v2|g' \
  -e 's|github.com/cdk8s-team/cdk8s-plus-go/cdk8splus36/v2|github.com/purecdk8s/purecdk8s/cdk8splus36/v2|g' \
...
go mod edit \
  ...
  -droprequire github.com/cdk8s-team/cdk8s-plus-go/cdk8splus34/v2 \
  -droprequire github.com/cdk8s-team/cdk8s-plus-go/cdk8splus35/v2 \
  -droprequire github.com/cdk8s-team/cdk8s-plus-go/cdk8splus36/v2 \

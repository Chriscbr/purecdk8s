...
find "$project" -type f -name '*.go' -exec sed -i \
  ...
  -e 's|github.com/cdk8s-team/cdk8s-plus-go/cdk8splus36/v2|github.com/Chriscbr/purecdk8s/cdk8splus36/v2|g' \
  -e 's|github.com/aws/constructs-go/constructs/v10|github.com/Chriscbr/purecdk8s/constructs/v10|g' \
  -e 's|github.com/aws/jsii-runtime-go|github.com/Chriscbr/purecdk8s/jsii|g' \
  {} +

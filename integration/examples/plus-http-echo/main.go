...
func NewHttpEcho(scope constructs.Construct, id string) cdk8s.Chart {
	...
	// TODO check why it is required to pass cdk8splus34.HttpIngressPathType_PREFIX
	ingress.AddRule(jsii.String("/"), EchoBackend(chart, "root"), cdk8splus34.HttpIngressPathType_PREFIX)
	ingress.AddRule(jsii.String("/foo"), EchoBackend(chart, "foo"), cdk8splus34.HttpIngressPathType_PREFIX)
	ingress.AddRule(jsii.String("/foo/bar"), EchoBackend(chart, "foo-bar"), cdk8splus34.HttpIngressPathType_PREFIX)
